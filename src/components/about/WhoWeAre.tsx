            ...
            <AnimateScrollReveal duration={1.2} className=' container grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-20 mt-14 mb-10 items-center'>
                <AnimateScrollReveal duration={1.5} animName='fadeInRight' delay={0.1} className=' col-span-1 md:col-span-2'>
                    ...
                    <Container as="p" className="my-3">
                        Driven by a profound belief in the transformative power of education, we stand as advocates for ambitious dreamers, providing tailored guidance and unwavering support to those seeking quality academic and professional development opportunities overseas. Our foundation is built on a blend of experience, expertise, and an unyielding dedication to our clients&rsquo; success.
                    </Container>
                    <Container as="p">
                        With a team of seasoned professionals, each passionate about fostering educational excellence, we endeavor to create pathways that transcend borders, unlocking doors to a world of possibilities. Our story is defined by the journeys we&rsquo;ve shaped, the dreams we&rsquo;ve empowered, and the lasting impact we&rsquo;ve forged through personalized, innovative, and reliable services.
                    </Container>
                </AnimateScrollReveal>
