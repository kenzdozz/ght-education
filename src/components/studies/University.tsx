...
const University = ({ school, country }: { school: string, country: string }) => {
    ...
    const submitMessage = async () => {
        ...
        try {
            const resp = await contactUs({ ...values, message: `I would like to know about stuying in ${school} that is in ${country}`, country: country, school: school });
            if (resp) {
