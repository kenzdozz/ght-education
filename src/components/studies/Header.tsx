...
const Header = ({ img, head, text }: { img?: string, head?: string, text?: string }) => {
    return (
        <Container className={` w-full relative h-[30rem] ${S.Header}`}>
            ...
            <Container className=' container relative h-full z-20 flex flex-col justify-center'>
                <Container as='h2' className=' capitalize text-white font-extrabold w-full md:w-2/3 lg:w-1/2 text-3xl md:text-5xl'>
                    {
