...
import { ContainerProps, TAnimatTransitionName } from '@/types';
...
> = ({ children, animName, className, allowOverflow, easing, delay, duration, ...props }): JSX.Element => {
  return (
    <Container
      {...useMemo(() => props, [props])}
      className={`${className || ''} anim trans__${animName || 'fadeInUp'} ${
