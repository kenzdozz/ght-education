...
export type SVGIconName = 'interview' | 'review' | 'document' | 'tourist' | 'petal' | 'school' | 'check' | 'atom' | 'ring' | 'flight' | 'speaker-phone' | 'plane-arrival' | 'sad-face' | 'accomodation' | 'apply' | 'badge' | 'grad-cap' | 'world' | 'face-book' | 'instagram'
